# Day 01 — Physical Design Overview

## Agenda

| Order | Content | Description | Objectives |
|---|---|---|---|
| 1 | Digital Background and CMOS process | • Overview of knowledge for Digital Design.<br>• Physical Structure and Fabrication Overview | • Grasp fundamental digital design concepts.<br>• Understand the IC fabrication flow and CMOS structures.
